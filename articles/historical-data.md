...
| `vehicle_class` | int | Class code 1-9 |
...
The `vehicle_class` column uses integer codes 1-9. The full mapping is
available via
...
#> 6             6 Car + trailer              ...
#> 7             7 Car + caravan / motorhome  ...
#> 8             8 Motorcycle / moped         ...
#> 9             9 High Capacity Truck        ...
```
